...
<head>
  ...
  <style>
        ...
        .cancel-text {
            font-size: 24px;
            font-weight: bold;
            color: #ff9800; /* Couleur orange pour annuler */
            margin-top: 10px;
        }
    </style>
  ...
  <main class="page-wrapper">
    ...
    <div class="container mt-5 mb-md-4 py-5">
      ...
      <div class="card card-body p-4 p-md-5 shadow-sm">
        ...
        <!-- SVG d'annulation (un cercle avec une barre diagonale) -->
        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="10" stroke="#ff9800" stroke-width="2"/>
            <line x1="8" y1="16" x2="16" y2="8" stroke="#ff9800" stroke-width="2" stroke-linecap="round"/>
        </svg>
        <!-- Texte au milieu de la page -->
        <div class="cancel-text">Annulée</div>
    </div>
