                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control" type="date" name="date_vol_depart" id="date_vol_depart">
                                    </div>
                                    <div class="col d-flex align-items-center justify-content-between">
                                        <div class="input-group input-group-lg border-end-md">
                                            <div class="dropdown w-100 mb-sm-0 mb-3" data-bs-toggle="select">
                                                <button class="btn btn-link btn-lg dropdown-toggle ps-2 ps-sm-3" type="button" data-bs-toggle="dropdown">
                                                    <i class="fi-list me-2"></i><span class="dropdown-toggle-label">Ville d'arrivée</span>
                                                </button>
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control" type="date" name="date_vol_arrivee" id="date_vol_arrivee">
                                    </div>
