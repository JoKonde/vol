      ...
      <div class="modal-dialog modal-lg modal-dialog-centered p-2 my-0 mx-auto" style="max-width: 950px;">
        <div class="modal-content">
          <div class="modal-body px-0 py-2 py-sm-0">
            ...
            <div class="row mx-0 align-items-center">
              <div class="col-md-6 border-end-md p-4 p-sm-5">
                <h2 class="h3 mb-4 mb-sm-5">Créez votre compte<br>Et Beneficiez de toutes nos offres!</h2>
                <img class="d-block mx-auto" src="img/signin-modal/signup.svg" width="344" alt="Illustartion">
                <div class="mt-sm-4 pt-md-3">Vous en avez déjà un ? <a href="#se-connecter" data-bs-toggle="modal" data-bs-dismiss="modal">Connectez-vous</a></div>
              </div>
              <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                
                <form class="needs-validation" method="post" action="t4.php">
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    <label class="form-label" for="signup-name">Sexe</label>
                  ...
                  <div class="mb-4">
                    ...
                    <input class="form-control" type="email" id="signup-email" name="email" placeholder="Adresse email..." required>
                  </div>
                  <div class="mb-4">
                    <label class="form-label" for="signup-password">Mot de Passe <span class='fs-sm text-muted'>min. 8 car</span></label>
                    <div class="password-toggle">
                      <input class="form-control" type="password" name="password" id="signup-password" minlength="8" required>
                      <label class="password-toggle-btn" aria-label="Show/hide password">
                        <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                      </label>
                    </div>
                  ...
                  <button class="btn btn-primary btn-lg rounded-pill w-100" type="submit">Créer</button>
                </form>
              </div>
            </div>
          </div>
